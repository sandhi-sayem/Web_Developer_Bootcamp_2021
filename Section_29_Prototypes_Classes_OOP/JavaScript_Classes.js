class Color {
    constructor(r, g, b, name) { // need to have constructon, it will run immediately
        this.r = r;
        this.g = g;
        this.b = b;
        this.name = name;
